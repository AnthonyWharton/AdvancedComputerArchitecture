...
pub fn commit_stage(state_p: &State, state: &mut State) -> bool {
    ...
    for entry in entries {
        match Format::from(state_p.reorder_buffer[entry].op) {
            Format::R => unimplemented!(), //cm_r_type(state_p, state, entry),
            Format::I => unimplemented!(), //cm_i_type(state_p, state, entry),
            Format::S => unimplemented!(), //cm_s_type(state_p, state, entry),
            Format::B => unimplemented!(), //cm_b_type(state_p, state, entry),
            Format::U => unimplemented!(), //cm_u_type(state_p, state, entry),
            Format::J => unimplemented!(), //cm_j_type(state_p, state, entry),
        }
