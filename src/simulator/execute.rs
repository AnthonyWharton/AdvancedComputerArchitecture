...
impl From<Operation> for ExecutionLen {
    ...
    fn from(op: Operation) -> ExecutionLen {
        match op {
            ...
            Operation::LB     => ExecutionLen { blocking: false, steps: 3 },
            Operation::LH     => ExecutionLen { blocking: false, steps: 3 },
            Operation::LW     => ExecutionLen { blocking: false, steps: 3 },
            Operation::LBU    => ExecutionLen { blocking: false, steps: 3 },
            Operation::LHU    => ExecutionLen { blocking: false, steps: 3 },
            Operation::SB     => ExecutionLen { blocking: false, steps: 3 },
            Operation::SH     => ExecutionLen { blocking: false, steps: 3 },
            Operation::SW     => ExecutionLen { blocking: false, steps: 3 },
